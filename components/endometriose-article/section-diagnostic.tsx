...
function DiagnosticCard({ section }: { section: DiagnosticSection }) {
  return (
    ...
    >
      {section.image ? (
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
          <DiagnosticCard section={section} />
          <div className="overflow-hidden rounded-3xl border border-[#e5cfc9] shadow-xl">
            <Image
              src={section.image}
