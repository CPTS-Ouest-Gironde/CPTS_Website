...
export const metadata: Metadata = {
  title: "Santé mentale - Les dispositifs du territoire",
  description:
    "Retrouvez toutes les informations utiles sur les dispositifs en santé mentale du territoire.",
};
...
export default function DispositifsTerritoirePage() {
  return (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <span>Retour à la page Santé mentale</span>
            </Link>
