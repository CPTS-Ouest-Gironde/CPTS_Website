...
export const chatbotConfig: ChatbotConfig = {
  resources: {
    ...
    "sm-numerique": {
      id: "sm-numerique",
      type: "internal",
      title: "Santé mentale et numérique",
      description:
        "Écrans, réseaux sociaux, sommeil, cyberharcèlement : l'impact du numérique sur le cerveau et dix repères pour un usage serein.",
      audience: "patient",
